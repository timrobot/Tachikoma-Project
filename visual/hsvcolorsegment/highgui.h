 ...
 */
void cvt_opencv2arma(const cv::Mat &cv_image, arma::mat &image, bool make_copy = true);
void cvt_opencv2arma(const cv::Mat &cv_image, arma::cube &image, bool make_copy = true);

/** Convert the arma::cube image to an OpenCV image
 *  @param image the arma::cube image
 *  @return the OpenCV image
 */
void cvt_arma2opencv(const arma::mat &image, cv::Mat &cv_image, bool make_copy = true);
void cvt_arma2opencv(const arma::cube &image, cv::Mat &cv_image, bool make_copy = true);
